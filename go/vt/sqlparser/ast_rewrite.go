...
func (a *application) rewriteSQLNode(parent SQLNode, node SQLNode, replacer replacerFunc) bool {
	...
	case *Point:
		return a.rewriteRefOfPoint(parent, node, replacer)
	case *PrepareStmt:
...
func (a *application) rewriteRefOfPoint(parent SQLNode, node *Point, replacer replacerFunc) bool {
	if node == nil {
		return true
	}
	if a.pre != nil {
	...
	if !a.rewriteExpr(node, node.XCordinate, func(newNode, parent SQLNode) {
		parent.(*Point).XCordinate = newNode.(Expr)
	}) {
		return false
	}
	if !a.rewriteExpr(node, node.YCordinate, func(newNode, parent SQLNode) {
		parent.(*Point).YCordinate = newNode.(Expr)
	}) {
		return false
	}
	if a.post != nil {
